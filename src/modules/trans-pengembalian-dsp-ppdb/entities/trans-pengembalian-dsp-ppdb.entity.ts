...
@Entity('trans_pengembalian_dsp_ppdb')
export class TransPengembalianDspPpdb {
  @PrimaryGeneratedColumn({ name: 'id_pengembalian_dsp_ppdb' })
  idPengembalianDspPpdb: number;
